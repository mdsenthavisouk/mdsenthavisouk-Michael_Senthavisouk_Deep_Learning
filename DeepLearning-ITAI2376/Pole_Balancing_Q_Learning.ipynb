...
- Random baseline average score: **17.3**
- Q-Learning final average (last 50 episodes): **65.1**
- Improvement from first 50 episodes (**22.7**) to last 50 (**65.1**)
- Epsilon schedule comparison:
  - Fast decay (0.990): 36.4
  - Slow decay (0.999): 42.4
  - Original (0.995): 65.1
